...
const navigation = [
  ...
  { name: 'Balances', href: '#', icon: TicketIcon, current: false },
...
const cards = [
  { name: 'Tickets sold', href: '#', icon: TicketIcon, amount: '2.345' },
  // More items...
]
const transactions = [
  {
    id: 1,
    name: 'Ticket Platea Alta',
    href: '#',
    amount: '$200,000',
    currency: 'CLP',
    status: 'success',
                        ...
                        <dl className="mt-6 flex flex-col sm:ml-3 sm:mt-1 sm:flex-row sm:flex-wrap">
                          ...
                          <dd className="flex items-center text-sm font-medium capitalize text-gray-500 sm:mr-6">
                            <BuildingOfficeIcon
                              ...
                              aria-hidden="true"
                            />
                            Circular Estudio, Santiago - Chile
                          </dd>
